...
[更新日志](https://github.com/html546/mylearn/commits/master)
...
- **WeChat or QQ**: <a :href="qqUrl" class='qq'>18853932891</a>
- **Email**:  <a href="mailto:1776787598@qq.com">1776787598@qq.com</a>
- **GitHub**: <https://github.com/html546>
...
<script>
  export default {
    data(){
      return {
        qqUrl: 'tencent://message/?uin=1776787598&Site=&Menu=yes'
      }
    },
    mounted(){
      const flag =  navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i);
      if(flag){
        this.qqUrl = 'mqqwpa://im/chat?chat_type=wpa&uin=1776787598&version=1&src_type=web&web_src=oicqzone.com'
      }
    }
  }
</script>
