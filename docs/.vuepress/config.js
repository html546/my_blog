...
module.exports = {
  ...
  themeConfig: {
    ...
    repo: 'html546/mylearn', // 导航栏右侧生成Github链接
    ...
    author: {
      ...
      name: 'html546', // 必需
      link: 'https://github.com/html546', // 可选的
    },
    blogger: {
      // 博主信息，显示在首页侧边栏
      avatar:
        // 'https://cdn.jsdelivr.net/gh/xugaoyi/image_store/blog/20200103123203.jpg',
        'https://avatars0.githubusercontent.com/u/24297621?s=60&v=4',
      name: 'html546',
      slogan: '只有我不在的街道',
    },
    social: {
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:1776787598@qq.com',
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/html546',
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
    ...
    footer: {
      ...
      copyrightInfo:
        'html546 | <a href="https://github.com/html546/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    },
  },
  plugins: [
    // 插件
